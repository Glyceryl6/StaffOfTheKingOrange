...
public class KOItemRegUtils {

    public static DeferredHolder<Item, Item> normal(String name) {
        return KOItems.ITEMS.register(name, () -> new Item(new Item.Properties()));
    }

    public static DeferredHolder<Item, Item> food(String name, int nutrition, float saturation) {
        return KOItems.ITEMS.register(name, () -> new Item(new Item.Properties().food(
    ...
    public static DeferredHolder<Item, Item> alias(String name, DeferredHolder<Block, Block> block, Item.Properties properties) {
        return KOItems.ITEMS.register(name, () -> new ItemNameBlockItem(block.get(), properties));
    }
    ...
    public static DeferredHolder<Item, Item> spawnEgg(String name, Supplier<? extends EntityType<? extends Mob>> type, int backgroundColor, int highlightColor) {
        return KOItems.ITEMS.register(name + "_spawn_egg", () -> new DeferredSpawnEggItem(type, backgroundColor, highlightColor, new Item.Properties()));
    }
