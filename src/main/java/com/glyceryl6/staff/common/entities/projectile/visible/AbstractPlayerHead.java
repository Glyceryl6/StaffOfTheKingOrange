...
public class AbstractPlayerHead extends AbstractHurtingProjectile {
    ...
    public AbstractPlayerHead(EntityType<? extends AbstractPlayerHead> type, Level level, LivingEntity shooter, Vec3 pMovement) {
        super(type, shooter, pMovement, level);
    }
